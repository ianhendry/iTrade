...
import { TradeSignalsComponent } from 'app/entities/trade-signals/trade-signals.component';
...
describe('Component Tests', () => {
  describe('TradeSignals Management Component', () => {
    let comp: TradeSignalsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [TradeSignalsComponent],
        providers: [
          {
        ...
        .overrideTemplate(TradeSignalsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tradeSignals && comp.tradeSignals[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
