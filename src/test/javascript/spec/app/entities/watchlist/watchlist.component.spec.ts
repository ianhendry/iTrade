...
import { WatchlistComponent } from 'app/entities/watchlist/watchlist.component';
...
describe('Component Tests', () => {
  describe('Watchlist Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.watchlists && comp.watchlists[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
