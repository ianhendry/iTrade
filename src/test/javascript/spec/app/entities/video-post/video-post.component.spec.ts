...
import { VideoPostComponent } from 'app/entities/video-post/video-post.component';
...
describe('Component Tests', () => {
  describe('VideoPost Management Component', () => {
    let comp: VideoPostComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VideoPostComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.videoPosts && comp.videoPosts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
