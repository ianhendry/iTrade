...
import { SiteAccountComponent } from 'app/entities/site-account/site-account.component';
...
describe('Component Tests', () => {
  describe('SiteAccount Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.siteAccounts && comp.siteAccounts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
