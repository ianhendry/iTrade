...
export class SiteAccountComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.siteAccountService
      ...
      .subscribe(
        (res: HttpResponse<ISiteAccount[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: ISiteAccount): number {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInSiteAccounts(): void {
    this.eventSubscriber = this.eventManager.subscribe('siteAccountListModification', () => this.loadPage());
  }

  delete(siteAccount: ISiteAccount): void {
    const modalRef = this.modalService.open(SiteAccountDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: ISiteAccount[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
