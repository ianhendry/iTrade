...
export class ShippingDetailsService {
  ...
  protected convertDateFromClient(shippingDetails: IShippingDetails): IShippingDetails {
    const copy: IShippingDetails = Object.assign({}, shippingDetails, {
      dateAdded:
        shippingDetails.dateAdded && shippingDetails.dateAdded.isValid() ? shippingDetails.dateAdded.format(DATE_FORMAT) : undefined,
      dateInactive:
        shippingDetails.dateInactive && shippingDetails.dateInactive.isValid()
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((shippingDetails: IShippingDetails) => {
        shippingDetails.dateAdded = shippingDetails.dateAdded ? moment(shippingDetails.dateAdded) : undefined;
        shippingDetails.dateInactive = shippingDetails.dateInactive ? moment(shippingDetails.dateInactive) : undefined;
      });
    }
    return res;
  }
