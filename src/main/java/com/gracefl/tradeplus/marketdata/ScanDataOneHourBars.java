...
public class ScanDataOneHourBars {
	...
	public void scanBar (InstrumentOHLC newBar) {
		...
		log.debug("ScanBar 1HR eurUsdBarHistory size = " + eurUsdBarHistory.size());
		log.debug("ScanBar 1HR gbpUsdBarHistory size = " + gbpUsdBarHistory.size());
		log.debug("ScanBar 1HR goldBarHistory size = " + goldBarHistory.size());
	}
