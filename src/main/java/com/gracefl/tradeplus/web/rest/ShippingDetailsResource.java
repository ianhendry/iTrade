...
/**
 * REST controller for managing {@link com.gracefl.tradeplus.domain.ShippingDetails}.
 */
@RestController
@RequestMapping("/api")
public class ShippingDetailsResource {
    ...
    public ResponseEntity<List<ShippingDetails>> getAllShippingDetails(Pageable pageable) {
        log.debug("REST request to get a page of ShippingDetails");
        Page<ShippingDetails> page = shippingDetailsService.findAll(pageable);
