...
/**
 * REST controller for managing {@link com.gracefl.tradeplus.domain.Watchlist}.
 */
@RestController
@RequestMapping("/api")
public class WatchlistResource {
    ...
    public ResponseEntity<List<Watchlist>> getAllWatchlists(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
